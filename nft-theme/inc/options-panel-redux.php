...
$opt_name = 'nft_option';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
Redux::set_section(
    $opt_name,
    array(
        'title'            => esc_html__( 'Global Settings', 'nft-theme' ),
        'id'               => 'global_settings',
        'desc'             => esc_html__( 'Options for header and footer', 'nft-theme' ),
...
Redux::set_section(
    $opt_name, array(
        'title' => esc_html__('Social_Profiles', 'nft-theme'),
        'id' => 'social_profiles',
        'subsection' => true,
        'customizer_width' => '450px',
        'desc' => esc_html__('Add Links profiles for social', 'nft-theme'),
        'fields' => array(array('id' => 'social_links',
            'type' => 'sortable',
            'title' => __('Social Links', 'nft-theme'),
            'subtitle' => esc_html__('Insert links fot your social profile', 'nft-theme'),
            'label'=> true,
            'options'=>array(
                'Facebook Link'=> '',
                'Twitter'=> '',
...
Redux::set_section(
  $opt_name,array(
      'title'=>esc_html__('Logo','nft-theme'),
      'id'=>'logo_header',
      'subsection'=>true,
      'customizer_width'=>'30px',
      'desc'=>esc_html__('Add media file and data for Logo','nft-theme'),
      'fields'=>array(
          array(
              'id'=>'header_bg',
              'type'=>'media',
              'url'=>true,
              'title'=>esc_html__('Background for Home Header','nft-theme'),
              'compiler'=>true,
              'desc'=>esc_html__('Recommended size 30x30px','nft-theme'),
              'default'=>array('url'=>get_template_directory().'/assets/img/nft_logo.png')
          )
      )
    )
);
...
Redux::set_section(
    $opt_name, array(
        'title' => esc_html__('Contact Data', 'nft-theme'),
        'id' => 'contacts_profiles',
        'subsection' => true,
        'customizer_width' => '450px',
        'desc' => esc_html__('Add Contacts Data', 'nft-theme'),
        'fields' => array(
            array(
                'id'=>'footer_phone_label',
                'type'=>'text',
                'title'=>__('Footer Phone Label','nft-theme'),
                'subtitle'=>__('Insert the Label','nft-theme'),
                'default'=>'Связаться с нами'
            ),array(
                'id'=>'footer-email',
                'type'=>'text',
                'title'=>esc_html__('Email','nft-theme'),
                'validate'=>'email',
                'msg'=>'Email format is isn`t correct',
                'default'=>'Email'
            ),
            array(
                'id'=>'footer_address',
                'type'=>'text',
                'title'=>esc_html__('Your address','nft-theme'),
                'default'=>'My Address not home and not street, my address is USSR'
            ),
            array(
                'id'=>'footer-copyright',
                'type'=>'editor',
                'title'=>esc_html__('Editor CopyRight','nft-theme' ),
                'default'=>'@Copyright',
                'args'=>array(
                    'wpautop'=>false,
                    'mediabutton'=>false,
